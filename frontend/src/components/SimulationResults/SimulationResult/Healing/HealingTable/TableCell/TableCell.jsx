...
const TableCell = ({ index, type, style, children, subSpells, rowsExpanded, setRowsExpanded, customClassName, breakdown, handleHeaderClick, sortHeader, sortDirection }) => {
    ...
    return <div className={`table-${type}-cell ${customClassName}`} style={style} onClick={() => handleHeaderClick(children)}>
        {children}
        {showSubspellArrow() && (
