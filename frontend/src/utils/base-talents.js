...
const specTalentsLive = [
    ...
    "",
    "",
    "Moment of Compassion/Resplendent Light",
    "",
    "Tirion's Devotion",
    "",
    "Unending Light",
    "",
    "Awestruck/Holy Infusion",
    "",
    "Divine Revelations",
    "",
    "Holy Prism/Barrier of Faith",
    "",
    "Unwavering Spirit/Protection of Tyr",
    "",
    "Imbued Infusions",
    "",
    "Light of the Martyr",
    ...
    "Veneration",
    "",
    "Avenging Wrath: Might/Avenging Crusader",
    "",
    "Tyr's Deliverance",
    "",
    "Truth Prevails",
    ...
    "",
    "Glorious Dawn",
    "Merciful Auras/Blessing of Summer",
    "Inflorescence of the Sunwell/Empyrean Legacy",
    "",
    "Boundless Salvation",
    "",
];
...
let baseClassTalentsLive = {
    ...
    row2: {
        ...
        "Auras of the Resolute": {
            ranks: { "current rank": 0, "max rank": 1 },
        },
    ...
    row8: {
        "Strength of Conviction": {
            ranks: { "current rank": 0, "max rank": 2 },
        },
...
const heroTalentsHeraldOfTheSunLive = [
    ...
    "Dawnlight",
    "",
    "Morning Star/Gleaming Rays",
    "Eternal Flame",
    "Luminosity",
    "Illumine/Will of the Dawn",
...
const lightsmithTalentsArrowsLive = {
    ...
    left: ["Holy Bulwark", "Hammer and Anvil"],
    right: ["Holy Bulwark", "Shared Resolve"],
};
...
const heraldOfTheSunTalentsArrowsLive = {
    ...
    left: ["Dawnlight", "Second Sunrise"],
    right: ["Dawnlight", "Aurora"],
};
