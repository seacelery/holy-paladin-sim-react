...
const TableCell = ({ index, type, style, children, subSpells, targets, rowsExpanded, setRowsExpanded, customClassName, breakdown, handleHeaderClick, sortHeader, sortDirection, totalManaGained = 0, subSpellHasHolyPower = false}) => {
    ...
    const showSubspellArrow = () => {
        if (!subSpells || Object.keys(subSpells).length === 0 || totalManaGained === 0 && !subSpellHasHolyPower) {
            return false;
        };
        return Object.keys(subSpells);
    };
